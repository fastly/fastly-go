...
`func (o *LoggingPapertrailResponse) GetFormatVersion() int32`

GetFormatVersion returns the FormatVersion field if non-nil, zero value otherwise.

### GetFormatVersionOk

`func (o *LoggingPapertrailResponse) GetFormatVersionOk() (*int32, bool)`
...
`func (o *LoggingPapertrailResponse) SetFormatVersion(v int32)`
...
`func (o *LoggingPapertrailResponse) GetVersion() int32`

GetVersion returns the Version field if non-nil, zero value otherwise.

### GetVersionOk

`func (o *LoggingPapertrailResponse) GetVersionOk() (*int32, bool)`
...
`func (o *LoggingPapertrailResponse) SetVersion(v int32)`
