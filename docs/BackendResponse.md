...
`func (o *BackendResponse) GetFetchTimeout() int32`

GetFetchTimeout returns the FetchTimeout field if non-nil, zero value otherwise.

### GetFetchTimeoutOk

`func (o *BackendResponse) GetFetchTimeoutOk() (*int32, bool)`
...
`func (o *BackendResponse) SetFetchTimeout(v int32)`

SetFetchTimeout sets FetchTimeout field to given value.

### HasFetchTimeout

`func (o *BackendResponse) HasFetchTimeout() bool`
...
`func (o *BackendResponse) SetMaxLifetimeNil(b bool)`
...
`func (o *BackendResponse) SetMaxUseNil(b bool)`
