...
------------ | ------------- | ------------- | -------------
**Product** | Pointer to [**DomainResearchResponseProductProduct**](DomainResearchResponseProductProduct.md) |  | [optional] 

## Methods

### NewDomainResearchResponseProduct
...
### NewDomainResearchResponseProductWithDefaults
