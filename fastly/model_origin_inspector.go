...
type OriginInspector struct {
	Timestamp *OriginInspectorSubsequentRequestTimestamp `json:"Timestamp,omitempty"`
...
func (o *OriginInspector) GetTimestamp() OriginInspectorSubsequentRequestTimestamp {
	if o == nil || o.Timestamp == nil {
		var ret OriginInspectorSubsequentRequestTimestamp
		return ret
	}
	return *o.Timestamp
}
...
// SetTimestamp gets a reference to the given OriginInspectorSubsequentRequestTimestamp and assigns it to the Timestamp field.
