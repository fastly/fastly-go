...
// VersionsResponse A paginated list of versions.
type VersionsResponse struct {
	Data                 []RoutingConfigVersionResponse `json:"data,omitempty"`
...
func (o *VersionsResponse) GetData() []RoutingConfigVersionResponse {
	if o == nil || o.Data == nil {
		var ret []RoutingConfigVersionResponse
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []RoutingConfigVersionResponse and assigns it to the Data field.
...
func (o *VersionsResponse) UnmarshalJSON(bytes []byte) (err error) {
	varVersionsResponse := _VersionsResponse{}

	if err = json.Unmarshal(bytes, &varVersionsResponse); err == nil {
...
// NullableVersionsResponse is a helper abstraction for handling nullable versionsresponse types.
...
// NewNullableVersionsResponse returns a pointer to a new instance of NullableVersionsResponse.
