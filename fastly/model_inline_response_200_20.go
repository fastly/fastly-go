...
func (o *InlineResponse20020) UnmarshalJSON(bytes []byte) (err error) {
	varInlineResponse20020 := _InlineResponse20020{}

	if err = json.Unmarshal(bytes, &varInlineResponse20020); err == nil {
...
// NullableInlineResponse20020 is a helper abstraction for handling nullable inlineresponse20020 types.
...
// NewNullableInlineResponse20020 returns a pointer to a new instance of NullableInlineResponse20020.
