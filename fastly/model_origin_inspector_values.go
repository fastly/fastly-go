...
type _OriginInspectorValues OriginInspectorValues
...
func (o OriginInspectorValues) MarshalJSON() ([]byte, error) {
...
func (o *OriginInspectorValues) UnmarshalJSON(bytes []byte) (err error) {
	varOriginInspectorValues := _OriginInspectorValues{}

	if err = json.Unmarshal(bytes, &varOriginInspectorValues); err == nil {
		*o = OriginInspectorValues(varOriginInspectorValues)
	}
...
// NullableOriginInspectorValues is a helper abstraction for handling nullable origininspectorvalues types. 
type NullableOriginInspectorValues struct {
	value *OriginInspectorValues
	isSet bool
}

// Get returns the value.
func (v NullableOriginInspectorValues) Get() *OriginInspectorValues {
	return v.value
}

// Set modifies the value.
func (v *NullableOriginInspectorValues) Set(val *OriginInspectorValues) {
	v.value = val
	v.isSet = true
}

// IsSet indicates if the value was set.
func (v NullableOriginInspectorValues) IsSet() bool {
	return v.isSet
}

// Unset removes the value.
func (v *NullableOriginInspectorValues) Unset() {
	v.value = nil
	v.isSet = false
}

// NewNullableOriginInspectorValues returns a pointer to a new instance of NullableOriginInspectorValues.
func NewNullableOriginInspectorValues(val *OriginInspectorValues) *NullableOriginInspectorValues {
	return &NullableOriginInspectorValues{value: val, isSet: true}
}

// MarshalJSON implements the json.Marshaler interface.
// Marshaler is the interface implemented by types that can marshal themselves into valid JSON.
func (v NullableOriginInspectorValues) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

// UnmarshalJSON implements the Unmarshaler interface.
// Unmarshaler is the interface implemented by types that can unmarshal a JSON description of themselves. 
func (v *NullableOriginInspectorValues) UnmarshalJSON(src []byte) error {
	v.isSet = true
