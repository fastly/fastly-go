...
type DomainOwnershipsAPI interface {
	...
	*/
	...
	ListDomainOwnershipsExecute(r APIListDomainOwnershipsRequest) (*InlineResponse2001, *http.Response, error)
}
...
func (r APIListDomainOwnershipsRequest) Execute() (*InlineResponse2001, *http.Response, error) {
...
// ListDomainOwnershipsExecute executes the request
//  @return InlineResponse2001
func (a *DomainOwnershipsAPIService) ListDomainOwnershipsExecute(r APIListDomainOwnershipsRequest) (*InlineResponse2001, *http.Response, error) {
	var (
