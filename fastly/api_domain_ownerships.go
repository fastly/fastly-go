...
type DomainOwnershipsAPI interface {
	...
	*/
	...
	ListDomainOwnershipsExecute(r APIListDomainOwnershipsRequest) (*InlineResponse20015, *http.Response, error)
}
...
func (r APIListDomainOwnershipsRequest) Execute() (*InlineResponse20015, *http.Response, error) {
...
// ListDomainOwnershipsExecute executes the request
//  @return InlineResponse20015
func (a *DomainOwnershipsAPIService) ListDomainOwnershipsExecute(r APIListDomainOwnershipsRequest) (*InlineResponse20015, *http.Response, error) {
	var (
