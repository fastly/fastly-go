...
type DomainOwnershipsAPI interface {
	...
	*/
	...
	ListDomainOwnershipsExecute(r APIListDomainOwnershipsRequest) (*InlineResponse2008, *http.Response, error)
}
...
func (r APIListDomainOwnershipsRequest) Execute() (*InlineResponse2008, *http.Response, error) {
...
// ListDomainOwnershipsExecute executes the request
//  @return InlineResponse2008
func (a *DomainOwnershipsAPIService) ListDomainOwnershipsExecute(r APIListDomainOwnershipsRequest) (*InlineResponse2008, *http.Response, error) {
	var (
