...
type DomainOwnershipsAPI interface {
	...
	*/
	...
	ListDomainOwnershipsExecute(r APIListDomainOwnershipsRequest) (*InlineResponse2005, *http.Response, error)
}
...
func (r APIListDomainOwnershipsRequest) Execute() (*InlineResponse2005, *http.Response, error) {
...
// ListDomainOwnershipsExecute executes the request
//  @return InlineResponse2005
func (a *DomainOwnershipsAPIService) ListDomainOwnershipsExecute(r APIListDomainOwnershipsRequest) (*InlineResponse2005, *http.Response, error) {
	var (
