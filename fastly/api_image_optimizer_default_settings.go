...
// ImageOptimizerDefaultSettingsAPI defines an interface for interacting with the resource.
type ImageOptimizerDefaultSettingsAPI interface {
	...
	*/
	...
	//  @return DefaultSettingsResponse
	UpdateDefaultSettingsExecute(r APIUpdateDefaultSettingsRequest) (*DefaultSettingsResponse, *http.Response, error)
}

// ImageOptimizerDefaultSettingsAPIService ImageOptimizerDefaultSettingsAPI service
type ImageOptimizerDefaultSettingsAPIService service
...
// DefaultSettings returns a pointer to a request.
func (r *APIUpdateDefaultSettingsRequest) DefaultSettings(defaultSettings DefaultSettings) *APIUpdateDefaultSettingsRequest {
	r.defaultSettings = &defaultSettings
	return r
}

// Execute calls the API using the request data configured.
func (r APIUpdateDefaultSettingsRequest) Execute() (*DefaultSettingsResponse, *http.Response, error) {
	return r.APIService.UpdateDefaultSettingsExecute(r)
}
...
func (a *ImageOptimizerDefaultSettingsAPIService) UpdateDefaultSettingsExecute(r APIUpdateDefaultSettingsRequest) (*DefaultSettingsResponse, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.defaultSettings
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["token"]; ok {
