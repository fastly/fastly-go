...
// LoggingCommonResponseAllOf struct for LoggingCommonResponseAllOf
...
type _LoggingCommonResponseAllOf LoggingCommonResponseAllOf
...
func NewLoggingCommonResponseAllOf() *LoggingCommonResponseAllOf {
	this := LoggingCommonResponseAllOf{}
...
func (o LoggingCommonResponseAllOf) MarshalJSON() ([]byte, error) {
...
func (o *LoggingCommonResponseAllOf) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &varLoggingCommonResponseAllOf); err == nil {
		*o = LoggingCommonResponseAllOf(varLoggingCommonResponseAllOf)
	}
...
func (v NullableLoggingCommonResponseAllOf) Get() *LoggingCommonResponseAllOf {
	return v.value
}

// Set modifies the value.
func (v *NullableLoggingCommonResponseAllOf) Set(val *LoggingCommonResponseAllOf) {
	v.value = val
	v.isSet = true
}

// IsSet indicates if the value was set.
func (v NullableLoggingCommonResponseAllOf) IsSet() bool {
	return v.isSet
}

// Unset removes the value.
func (v *NullableLoggingCommonResponseAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

// NewNullableLoggingCommonResponseAllOf returns a pointer to a new instance of NullableLoggingCommonResponseAllOf.
func NewNullableLoggingCommonResponseAllOf(val *LoggingCommonResponseAllOf) *NullableLoggingCommonResponseAllOf {
	return &NullableLoggingCommonResponseAllOf{value: val, isSet: true}
}

// MarshalJSON implements the json.Marshaler interface.
// Marshaler is the interface implemented by types that can marshal themselves into valid JSON.
func (v NullableLoggingCommonResponseAllOf) MarshalJSON() ([]byte, error) {
