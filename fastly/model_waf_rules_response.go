...
// WafRulesResponse struct for WafRulesResponse
...
type _WafRulesResponse WafRulesResponse
...
func (o WafRulesResponse) MarshalJSON() ([]byte, error) {
...
func (o *WafRulesResponse) UnmarshalJSON(bytes []byte) (err error) {
	varWafRulesResponse := _WafRulesResponse{}

	if err = json.Unmarshal(bytes, &varWafRulesResponse); err == nil {
		*o = WafRulesResponse(varWafRulesResponse)
	}
...
// NullableWafRulesResponse is a helper abstraction for handling nullable wafrulesresponse types. 
type NullableWafRulesResponse struct {
	value *WafRulesResponse
	isSet bool
}

// Get returns the value.
func (v NullableWafRulesResponse) Get() *WafRulesResponse {
	return v.value
}

// Set modifies the value.
func (v *NullableWafRulesResponse) Set(val *WafRulesResponse) {
	v.value = val
	v.isSet = true
}

// IsSet indicates if the value was set.
func (v NullableWafRulesResponse) IsSet() bool {
	return v.isSet
}

// Unset removes the value.
func (v *NullableWafRulesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

// NewNullableWafRulesResponse returns a pointer to a new instance of NullableWafRulesResponse.
func NewNullableWafRulesResponse(val *WafRulesResponse) *NullableWafRulesResponse {
	return &NullableWafRulesResponse{value: val, isSet: true}
}

// MarshalJSON implements the json.Marshaler interface.
// Marshaler is the interface implemented by types that can marshal themselves into valid JSON.
func (v NullableWafRulesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

// UnmarshalJSON implements the Unmarshaler interface.
// Unmarshaler is the interface implemented by types that can unmarshal a JSON description of themselves. 
func (v *NullableWafRulesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
