...
// LoggingHeroku struct for LoggingHeroku
...
type _LoggingHeroku LoggingHeroku
...
func (o *LoggingHeroku) SetPlacementNil() {
	o.Placement.Set(nil)
}
...
func (o *LoggingHeroku) SetResponseConditionNil() {
...
func (o LoggingHeroku) MarshalJSON() ([]byte, error) {
...
func (o *LoggingHeroku) UnmarshalJSON(bytes []byte) (err error) {
	varLoggingHeroku := _LoggingHeroku{}

	if err = json.Unmarshal(bytes, &varLoggingHeroku); err == nil {
		*o = LoggingHeroku(varLoggingHeroku)
	}
...
// NullableLoggingHeroku is a helper abstraction for handling nullable loggingheroku types. 
type NullableLoggingHeroku struct {
	value *LoggingHeroku
	isSet bool
}

// Get returns the value.
func (v NullableLoggingHeroku) Get() *LoggingHeroku {
	return v.value
}

// Set modifies the value.
func (v *NullableLoggingHeroku) Set(val *LoggingHeroku) {
	v.value = val
	v.isSet = true
}

// IsSet indicates if the value was set.
func (v NullableLoggingHeroku) IsSet() bool {
	return v.isSet
}

// Unset removes the value.
func (v *NullableLoggingHeroku) Unset() {
	v.value = nil
	v.isSet = false
}

// NewNullableLoggingHeroku returns a pointer to a new instance of NullableLoggingHeroku.
func NewNullableLoggingHeroku(val *LoggingHeroku) *NullableLoggingHeroku {
	return &NullableLoggingHeroku{value: val, isSet: true}
}

// MarshalJSON implements the json.Marshaler interface.
// Marshaler is the interface implemented by types that can marshal themselves into valid JSON.
func (v NullableLoggingHeroku) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

// UnmarshalJSON implements the Unmarshaler interface.
// Unmarshaler is the interface implemented by types that can unmarshal a JSON description of themselves. 
func (v *NullableLoggingHeroku) UnmarshalJSON(src []byte) error {
	v.isSet = true
