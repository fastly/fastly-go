...
// WafRuleRevision struct for WafRuleRevision
...
type _WafRuleRevision WafRuleRevision
...
func (o WafRuleRevision) MarshalJSON() ([]byte, error) {
...
func (o *WafRuleRevision) UnmarshalJSON(bytes []byte) (err error) {
	varWafRuleRevision := _WafRuleRevision{}

	if err = json.Unmarshal(bytes, &varWafRuleRevision); err == nil {
		*o = WafRuleRevision(varWafRuleRevision)
	}
...
type NullableWafRuleRevision struct {
	value *WafRuleRevision
	isSet bool
}

// Get returns the value.
func (v NullableWafRuleRevision) Get() *WafRuleRevision {
	return v.value
}

// Set modifies the value.
func (v *NullableWafRuleRevision) Set(val *WafRuleRevision) {
	v.value = val
	v.isSet = true
}

// IsSet indicates if the value was set.
func (v NullableWafRuleRevision) IsSet() bool {
	return v.isSet
}

// Unset removes the value.
func (v *NullableWafRuleRevision) Unset() {
	v.value = nil
	v.isSet = false
}

// NewNullableWafRuleRevision returns a pointer to a new instance of NullableWafRuleRevision.
func NewNullableWafRuleRevision(val *WafRuleRevision) *NullableWafRuleRevision {
	return &NullableWafRuleRevision{value: val, isSet: true}
}

// MarshalJSON implements the json.Marshaler interface.
// Marshaler is the interface implemented by types that can marshal themselves into valid JSON.
func (v NullableWafRuleRevision) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

// UnmarshalJSON implements the Unmarshaler interface.
// Unmarshaler is the interface implemented by types that can unmarshal a JSON description of themselves. 
func (v *NullableWafRuleRevision) UnmarshalJSON(src []byte) error {
	v.isSet = true
