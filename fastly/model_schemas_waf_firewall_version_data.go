...
// SchemasWafFirewallVersionData struct for SchemasWafFirewallVersionData
...
type _SchemasWafFirewallVersionData SchemasWafFirewallVersionData
...
func NewSchemasWafFirewallVersionData() *SchemasWafFirewallVersionData {
	this := SchemasWafFirewallVersionData{}
...
func (o SchemasWafFirewallVersionData) MarshalJSON() ([]byte, error) {
...
func (o *SchemasWafFirewallVersionData) UnmarshalJSON(bytes []byte) (err error) {
	varSchemasWafFirewallVersionData := _SchemasWafFirewallVersionData{}

	if err = json.Unmarshal(bytes, &varSchemasWafFirewallVersionData); err == nil {
		*o = SchemasWafFirewallVersionData(varSchemasWafFirewallVersionData)
	}
...
// NullableSchemasWafFirewallVersionData is a helper abstraction for handling nullable schemaswaffirewallversiondata types.
type NullableSchemasWafFirewallVersionData struct {
	value *SchemasWafFirewallVersionData
	isSet bool
}

// Get returns the value.
func (v NullableSchemasWafFirewallVersionData) Get() *SchemasWafFirewallVersionData {
	return v.value
}

// Set modifies the value.
func (v *NullableSchemasWafFirewallVersionData) Set(val *SchemasWafFirewallVersionData) {
	v.value = val
	v.isSet = true
}

// IsSet indicates if the value was set.
func (v NullableSchemasWafFirewallVersionData) IsSet() bool {
	return v.isSet
}

// Unset removes the value.
func (v *NullableSchemasWafFirewallVersionData) Unset() {
	v.value = nil
	v.isSet = false
}

// NewNullableSchemasWafFirewallVersionData returns a pointer to a new instance of NullableSchemasWafFirewallVersionData.
func NewNullableSchemasWafFirewallVersionData(val *SchemasWafFirewallVersionData) *NullableSchemasWafFirewallVersionData {
	return &NullableSchemasWafFirewallVersionData{value: val, isSet: true}
}

// MarshalJSON implements the json.Marshaler interface.
// Marshaler is the interface implemented by types that can marshal themselves into valid JSON.
func (v NullableSchemasWafFirewallVersionData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

// UnmarshalJSON implements the Unmarshaler interface.
// Unmarshaler is the interface implemented by types that can unmarshal a JSON description of themselves.
func (v *NullableSchemasWafFirewallVersionData) UnmarshalJSON(src []byte) error {
	v.isSet = true
