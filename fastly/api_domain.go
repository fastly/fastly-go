...
// DomainAPI defines an interface for interacting with the resource.
type DomainAPI interface {
	...
	*/
	...
	//  @return DomainResponse
	UpdateDomainExecute(r APIUpdateDomainRequest) (*DomainResponse, *http.Response, error)
}
...
func (r *APICreateDomainRequest) Comment(comment string) *APICreateDomainRequest {
	r.comment = &comment
	return r
}
...
// Comment A freeform descriptive note.
func (r *APIUpdateDomainRequest) Comment(comment string) *APIUpdateDomainRequest {
	r.comment = &comment
	return r
}
...
// Execute calls the API using the request data configured.
func (r APIUpdateDomainRequest) Execute() (*DomainResponse, *http.Response, error) {
