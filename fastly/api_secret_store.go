...
type SecretStoreAPI interface {
	...
	*/
	...
	GetSecretStoresExecute(r APIGetSecretStoresRequest) (*InlineResponse2009, *http.Response, error)
...
// Execute calls the API using the request data configured.
func (r APIGetSecretStoresRequest) Execute() (*InlineResponse2009, *http.Response, error) {
...
// GetSecretStoresExecute executes the request
//  @return InlineResponse2009
func (a *SecretStoreAPIService) GetSecretStoresExecute(r APIGetSecretStoresRequest) (*InlineResponse2009, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    any
		formFiles           []formFile
