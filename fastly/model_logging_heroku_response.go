...
// LoggingHerokuResponse struct for LoggingHerokuResponse
...
type _LoggingHerokuResponse LoggingHerokuResponse
...
func (o *LoggingHerokuResponse) SetPlacementNil() {
	o.Placement.Set(nil)
}
...
func (o *LoggingHerokuResponse) GetFormatVersion() int32 {
...
// and a boolean to check if the value has been set.
func (o *LoggingHerokuResponse) GetFormatVersionOk() (*int32, bool) {
	if o == nil || o.FormatVersion == nil {
		return nil, false
	}
...
func (o *LoggingHerokuResponse) SetFormatVersion(v int32) {
	o.FormatVersion = &v
}
...
func (o *LoggingHerokuResponse) SetResponseConditionNil() {
...
func (o *LoggingHerokuResponse) SetCreatedAtNil() {
	o.CreatedAt.Set(nil)
}
...
func (o *LoggingHerokuResponse) SetDeletedAtNil() {
	o.DeletedAt.Set(nil)
}
...
func (o *LoggingHerokuResponse) SetUpdatedAtNil() {
	o.UpdatedAt.Set(nil)
}
...
func (o *LoggingHerokuResponse) GetVersion() int32 {
...
// and a boolean to check if the value has been set.
func (o *LoggingHerokuResponse) GetVersionOk() (*int32, bool) {
	if o == nil || o.Version == nil {
		return nil, false
	}
...
func (o *LoggingHerokuResponse) SetVersion(v int32) {
	o.Version = &v
}

// MarshalJSON implements the json.Marshaler interface.
// Marshaler is the interface implemented by types that can marshal themselves into valid JSON.
func (o LoggingHerokuResponse) MarshalJSON() ([]byte, error) {
...
func (o *LoggingHerokuResponse) UnmarshalJSON(bytes []byte) (err error) {
	varLoggingHerokuResponse := _LoggingHerokuResponse{}

	if err = json.Unmarshal(bytes, &varLoggingHerokuResponse); err == nil {
		*o = LoggingHerokuResponse(varLoggingHerokuResponse)
	}
...
// NullableLoggingHerokuResponse is a helper abstraction for handling nullable loggingherokuresponse types. 
type NullableLoggingHerokuResponse struct {
	value *LoggingHerokuResponse
	isSet bool
}

// Get returns the value.
func (v NullableLoggingHerokuResponse) Get() *LoggingHerokuResponse {
	return v.value
}

// Set modifies the value.
func (v *NullableLoggingHerokuResponse) Set(val *LoggingHerokuResponse) {
	v.value = val
	v.isSet = true
}

// IsSet indicates if the value was set.
func (v NullableLoggingHerokuResponse) IsSet() bool {
	return v.isSet
}

// Unset removes the value.
func (v *NullableLoggingHerokuResponse) Unset() {
	v.value = nil
	v.isSet = false
}

// NewNullableLoggingHerokuResponse returns a pointer to a new instance of NullableLoggingHerokuResponse.
func NewNullableLoggingHerokuResponse(val *LoggingHerokuResponse) *NullableLoggingHerokuResponse {
	return &NullableLoggingHerokuResponse{value: val, isSet: true}
}

// MarshalJSON implements the json.Marshaler interface.
// Marshaler is the interface implemented by types that can marshal themselves into valid JSON.
func (v NullableLoggingHerokuResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

// UnmarshalJSON implements the Unmarshaler interface.
// Unmarshaler is the interface implemented by types that can unmarshal a JSON description of themselves. 
func (v *NullableLoggingHerokuResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
