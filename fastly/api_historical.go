...
// Datacenter Limit query to one or more Fastly POPs. For multiple POPs use a comma-seperated list of POPs. These must be all uppercase and be valid codes. A full list of POPs can be obtained from the [POPs endpoint](https://www.fastly.com/documentation/reference/api/utils/pops/).
func (r *APIGetHistStatsRequest) Datacenter(datacenter string) *APIGetHistStatsRequest {
...
// Datacenter Limit query to one or more Fastly POPs. For multiple POPs use a comma-seperated list of POPs. These must be all uppercase and be valid codes. A full list of POPs can be obtained from the [POPs endpoint](https://www.fastly.com/documentation/reference/api/utils/pops/).
func (r *APIGetHistStatsFieldRequest) Datacenter(datacenter string) *APIGetHistStatsFieldRequest {
	r.datacenter = &datacenter
	return r
}
...
// Datacenter Limit query to one or more Fastly POPs. For multiple POPs use a comma-seperated list of POPs. These must be all uppercase and be valid codes. A full list of POPs can be obtained from the [POPs endpoint](https://www.fastly.com/documentation/reference/api/utils/pops/).
func (r *APIGetHistStatsServiceRequest) Datacenter(datacenter string) *APIGetHistStatsServiceRequest {
	r.datacenter = &datacenter
	return r
}
...
// Datacenter Limit query to one or more Fastly POPs. For multiple POPs use a comma-seperated list of POPs. These must be all uppercase and be valid codes. A full list of POPs can be obtained from the [POPs endpoint](https://www.fastly.com/documentation/reference/api/utils/pops/).
func (r *APIGetHistStatsServiceFieldRequest) Datacenter(datacenter string) *APIGetHistStatsServiceFieldRequest {
	r.datacenter = &datacenter
	return r
}
