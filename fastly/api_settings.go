...
// SettingsAPI defines an interface for interacting with the resource.
type SettingsAPI interface {
	...
	*/
	...
	//  @return SettingsResponse
	UpdateServiceSettingsExecute(r APIUpdateServiceSettingsRequest) (*SettingsResponse, *http.Response, error)
}
...
func (r APIGetServiceSettingsRequest) Execute() (*SettingsResponse, *http.Response, error) {
	return r.APIService.GetServiceSettingsExecute(r)
}
