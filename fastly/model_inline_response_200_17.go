...
func (o *InlineResponse20017) UnmarshalJSON(bytes []byte) (err error) {
	varInlineResponse20017 := _InlineResponse20017{}

	if err = json.Unmarshal(bytes, &varInlineResponse20017); err == nil {
...
// NullableInlineResponse20017 is a helper abstraction for handling nullable inlineresponse20017 types.
...
// NewNullableInlineResponse20017 returns a pointer to a new instance of NullableInlineResponse20017.
