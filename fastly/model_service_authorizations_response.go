...
type _ServiceAuthorizationsResponse ServiceAuthorizationsResponse
...
func NewServiceAuthorizationsResponse() *ServiceAuthorizationsResponse {
	this := ServiceAuthorizationsResponse{}
	return &this
}
...
func (o ServiceAuthorizationsResponse) MarshalJSON() ([]byte, error) {
...
func (o *ServiceAuthorizationsResponse) UnmarshalJSON(bytes []byte) (err error) {
	varServiceAuthorizationsResponse := _ServiceAuthorizationsResponse{}

	if err = json.Unmarshal(bytes, &varServiceAuthorizationsResponse); err == nil {
		*o = ServiceAuthorizationsResponse(varServiceAuthorizationsResponse)
	}
...
// NullableServiceAuthorizationsResponse is a helper abstraction for handling nullable serviceauthorizationsresponse types.
type NullableServiceAuthorizationsResponse struct {
	value *ServiceAuthorizationsResponse
	isSet bool
}

// Get returns the value.
func (v NullableServiceAuthorizationsResponse) Get() *ServiceAuthorizationsResponse {
	return v.value
}

// Set modifies the value.
func (v *NullableServiceAuthorizationsResponse) Set(val *ServiceAuthorizationsResponse) {
	v.value = val
	v.isSet = true
}

// IsSet indicates if the value was set.
func (v NullableServiceAuthorizationsResponse) IsSet() bool {
	return v.isSet
}

// Unset removes the value.
func (v *NullableServiceAuthorizationsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

// NewNullableServiceAuthorizationsResponse returns a pointer to a new instance of NullableServiceAuthorizationsResponse.
func NewNullableServiceAuthorizationsResponse(val *ServiceAuthorizationsResponse) *NullableServiceAuthorizationsResponse {
	return &NullableServiceAuthorizationsResponse{value: val, isSet: true}
}

// MarshalJSON implements the json.Marshaler interface.
// Marshaler is the interface implemented by types that can marshal themselves into valid JSON.
func (v NullableServiceAuthorizationsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

// UnmarshalJSON implements the Unmarshaler interface.
// Unmarshaler is the interface implemented by types that can unmarshal a JSON description of themselves.
func (v *NullableServiceAuthorizationsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
