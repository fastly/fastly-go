...
func (o *InlineResponse20022) GetData() []ServiceAuthorizationResponseData {
	if o == nil || o.Data == nil {
...
func (o *InlineResponse20022) GetDataOk() ([]ServiceAuthorizationResponseData, bool) {
	if o == nil || o.Data == nil {
		return nil, false
	}
	return o.Data, true
...
func (o *InlineResponse20022) SetData(v []ServiceAuthorizationResponseData) {
	o.Data = v
}
...
func (o *InlineResponse20022) UnmarshalJSON(bytes []byte) (err error) {
	varInlineResponse20022 := _InlineResponse20022{}

	if err = json.Unmarshal(bytes, &varInlineResponse20022); err == nil {
...
// NullableInlineResponse20022 is a helper abstraction for handling nullable inlineresponse20022 types.
...
// NewNullableInlineResponse20022 returns a pointer to a new instance of NullableInlineResponse20022.
