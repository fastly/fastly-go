...
// Timestamps struct for Timestamps
...
func (o *Timestamps) SetCreatedAtNil() {
	o.CreatedAt.Set(nil)
}
...
func (o *Timestamps) SetDeletedAtNil() {
	o.DeletedAt.Set(nil)
}
...
func (o *Timestamps) SetUpdatedAtNil() {
	o.UpdatedAt.Set(nil)
}
...
func (o *Timestamps) UnmarshalJSON(bytes []byte) (err error) {
	varTimestamps := _Timestamps{}

	if err = json.Unmarshal(bytes, &varTimestamps); err == nil {
...
// NullableTimestamps is a helper abstraction for handling nullable timestamps types. 
...
// NewNullableTimestamps returns a pointer to a new instance of NullableTimestamps.
