...
func (o *InlineResponse20018) GetMeta() PaginationCursorMeta {
	if o == nil || o.Meta == nil {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20018) GetMetaOk() (*PaginationCursorMeta, bool) {
	if o == nil || o.Meta == nil {
		return nil, false
	}
	return o.Meta, true
...
func (o *InlineResponse20018) HasMeta() bool {
	if o != nil && o.Meta != nil {
		return true
	}
...
func (o *InlineResponse20018) SetMeta(v PaginationCursorMeta) {
	o.Meta = &v
}
...
func (o *InlineResponse20018) UnmarshalJSON(bytes []byte) (err error) {
	varInlineResponse20018 := _InlineResponse20018{}

	if err = json.Unmarshal(bytes, &varInlineResponse20018); err == nil {
...
// NullableInlineResponse20018 is a helper abstraction for handling nullable inlineresponse20018 types.
...
// NewNullableInlineResponse20018 returns a pointer to a new instance of NullableInlineResponse20018.
