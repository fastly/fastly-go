...
type _HistoricalRegionsResponse HistoricalRegionsResponse
...
func NewHistoricalRegionsResponse() *HistoricalRegionsResponse {
	this := HistoricalRegionsResponse{}
	return &this
}
...
func (o HistoricalRegionsResponse) MarshalJSON() ([]byte, error) {
...
func (o *HistoricalRegionsResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &varHistoricalRegionsResponse); err == nil {
		*o = HistoricalRegionsResponse(varHistoricalRegionsResponse)
	}
...
func (v NullableHistoricalRegionsResponse) Get() *HistoricalRegionsResponse {
	return v.value
}

// Set modifies the value.
func (v *NullableHistoricalRegionsResponse) Set(val *HistoricalRegionsResponse) {
	v.value = val
	v.isSet = true
}

// IsSet indicates if the value was set.
func (v NullableHistoricalRegionsResponse) IsSet() bool {
	return v.isSet
}

// Unset removes the value.
func (v *NullableHistoricalRegionsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

// NewNullableHistoricalRegionsResponse returns a pointer to a new instance of NullableHistoricalRegionsResponse.
func NewNullableHistoricalRegionsResponse(val *HistoricalRegionsResponse) *NullableHistoricalRegionsResponse {
	return &NullableHistoricalRegionsResponse{value: val, isSet: true}
}

// MarshalJSON implements the json.Marshaler interface.
// Marshaler is the interface implemented by types that can marshal themselves into valid JSON.
func (v NullableHistoricalRegionsResponse) MarshalJSON() ([]byte, error) {
