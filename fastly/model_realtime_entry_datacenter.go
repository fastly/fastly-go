...
// RealtimeEntryDatacenter Groups [measurements](#measurements-data-model) by POP. See the [POPs API](https://www.fastly.com/documentation/reference/api/utils/pops/) for details of POP identifiers.
type RealtimeEntryDatacenter struct {
...
func (o *RealtimeEntryDatacenter) UnmarshalJSON(bytes []byte) (err error) {
	varRealtimeEntryDatacenter := _RealtimeEntryDatacenter{}

	if err = json.Unmarshal(bytes, &varRealtimeEntryDatacenter); err == nil {
		*o = RealtimeEntryDatacenter(varRealtimeEntryDatacenter)
	}
...
// NullableRealtimeEntryDatacenter is a helper abstraction for handling nullable realtimeentrydatacenter types.
type NullableRealtimeEntryDatacenter struct {
	value *RealtimeEntryDatacenter
	isSet bool
}

// Get returns the value.
func (v NullableRealtimeEntryDatacenter) Get() *RealtimeEntryDatacenter {
	return v.value
}

// Set modifies the value.
func (v *NullableRealtimeEntryDatacenter) Set(val *RealtimeEntryDatacenter) {
	v.value = val
	v.isSet = true
}

// IsSet indicates if the value was set.
func (v NullableRealtimeEntryDatacenter) IsSet() bool {
	return v.isSet
}

// Unset removes the value.
func (v *NullableRealtimeEntryDatacenter) Unset() {
	v.value = nil
	v.isSet = false
}

// NewNullableRealtimeEntryDatacenter returns a pointer to a new instance of NullableRealtimeEntryDatacenter.
func NewNullableRealtimeEntryDatacenter(val *RealtimeEntryDatacenter) *NullableRealtimeEntryDatacenter {
	return &NullableRealtimeEntryDatacenter{value: val, isSet: true}
}

// MarshalJSON implements the json.Marshaler interface.
// Marshaler is the interface implemented by types that can marshal themselves into valid JSON.
func (v NullableRealtimeEntryDatacenter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

// UnmarshalJSON implements the Unmarshaler interface.
// Unmarshaler is the interface implemented by types that can unmarshal a JSON description of themselves.
func (v *NullableRealtimeEntryDatacenter) UnmarshalJSON(src []byte) error {
	v.isSet = true
